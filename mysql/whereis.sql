...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2021 a las 01:47:36
...
--
-- CREATE DATABASE IF NOT EXISTS felipe;
-- --------------------------------------------------------
...
CREATE TABLE `localidades` (
  ...
  `Descripcion` varchar(99) CHARACTER SET utf8mb4 NOT NULL
...
CREATE TABLE `lugares` (
  `idLugar` int(19) UNSIGNED NOT NULL,
  `idPeople` int(19) NOT NULL,
...
CREATE TABLE `people` (
  `idPeople` int(19) UNSIGNED NOT NULL,
...
CREATE TABLE `token` (
  `idSession` int(19) UNSIGNED NOT NULL,
...
--
ALTER TABLE `lugares`
  MODIFY `idLugar` int(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `people`
--
ALTER TABLE `people`
  MODIFY `idPeople` int(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `provincias`
--
ALTER TABLE `provincias`
  MODIFY `idProvincia` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `token`
--
ALTER TABLE `token`
  MODIFY `idSession` int(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
