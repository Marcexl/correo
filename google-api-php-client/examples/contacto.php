...
if (isset($authUrl)) {
  ...
  echo '<p>&nbsp;</p></div></div></section>';
    ...
    ************************************************/
    ...
    <section id="contact">
      <div class="content">
      <img src="img/logos/contacto.png">
        <form action="sent.php" method="post">
            ...
            <div class="form-group">
                <input id="phone" type="text" name="phone" placeholder="Celular:" required>
            </div>
            <div class="form-group">
                <input id="monkey" type="text" name="monkey" placeholder="Asunto" required>
            </div>
            <div class="form-group">
                <textarea id="message" name="message" placeholder="Mensaje:" required=""></textarea>
            </div>
            <div class="clearfix"></div>
                    <input id="submit" type="submit" name="submit" value="Enviar" class="butForm"/></input>
            </div>
        </form>
      </div>
    </section>';
